...
public class Menu_GUI extends Application {
    ...
    TextField Names, Firstline, Secondline, City, County, Eircode, MarketValue;
    ChoiceBox Catagory, PrivateRes;
    ...
    public void start(Stage stage) {
        ...
        submit.setOnAction(e-> AddProp());
        HBox AddPropertyFields = new HBox();
        AddPropertyFields.getChildren().addAll(names, Names, firstline, Firstline, secondline, Secondline, city, City, county, County, eircode, Eircode, catagory, Catagory, privateRes, PrivateRes, submit);
